...
class CarouselItem extends React.Component {
  ...
  render() {
    return (
      <div className={styles['flexbox-item-carousel']} style={{ backgroundColor: this.props.color }}>
        ...
        <div className={`${styles.text} ${styles.fade}`} onClick={() => this.props.handleReviewModal(this.props.review, this.props.color)}>
        ...
        <div className={styles.other}>
          ...
          <div className={styles.flag} onClick={() => this.props.handleFlagToggle()}>Flag</div>
        </div>
      </div>
    );
  }
